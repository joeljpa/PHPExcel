...
/**
 * PHPExcel_Writer_Excel2007Custom_Chart
 *
 * @category   PHPExcel
 * @package    PHPExcel_Writer_Excel2007
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class PHPExcel_Writer_Excel2007Custom_Chart extends
  ...
  public function writeChart(PHPExcel_Chart $pChart = NULL) {
    ...
    /*
     * Modified Apr 2022 to add borders as per SO answer
     * https://stackoverflow.com/a/19396447/8958173
     */
    $cBorderColor = "111111";
  ...
  private function _writePlotGroup($plotGroup,
    ...
    /*
     * Modified on Apr 2022, lighter colours compared to default.
     */
    $ci=-1;
    $colorNDX=array();
    $colorNDX[0] = "f0bcaf";
    ...
    foreach ($plotSeriesOrder as $plotSeriesIdx => $plotSeriesRef) {
       ...
       * modified Apr 2022
       */
      $cBorderColor = "000000";//black
      $objWriter->startElement('c:spPr');
      $objWriter->startElement('a:ln');
      $objWriter->writeAttribute('w', '10000');//alters border thickness
      $objWriter->startElement('a:solidFill');
      $objWriter->startElement('a:srgbClr');
